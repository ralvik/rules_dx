...
def signing_unit_tests(name):
    starlark_test(
        ...
        checks = [
            ...
            expect_equal(
                "signing cosign sha is pinned linux-amd64",
                SIGNING_COSIGN_SHA256_LINUX_AMD64,
            ...
            expect_equal(
                ...
                signing_cosign_sha_error("8b24b946dd5809c6bd93de08033bcf6bc0ed7d336b7785787c080f574b89249b"),
                "",
            ),
            expect_equal(
