...
- [Support matrix](support-matrix.md) is the authoritative source for current application-foundation
  and quality support claims.

Detailed architecture and delivery documentation is indexed from the [documentation
README](../README.md).
