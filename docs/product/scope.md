...
| `dx docs` | removed; reintroduction with real extraction/validation open under issue #310 | Build, check, and serve the unified documentation site; `--check` is non-mutating |
