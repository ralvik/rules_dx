# Generation Foundation Qualification

Foundation-to-upstream mapping and lock/runner evidence for first-party BUILD generation.
The [Generation index](README.md) stays short; this document owns the qualification record.
