...
- Docs pipeline and environment/codegen stay open under #783 plus #785 and #787 (see
  ...
  planning plus adapter runs plus site-execution plus rebuild plus link plus timing records with fixture evidence are qualified seed-only under #779
  plus #780 plus #781 plus #782 plus #784
  ...
  outputs only plus byte-identical rebuild proof plus link/reference completeness with no dangling targets plus first-hour timing proof one-shot per ADR 0022 with no CI timing budget; guide-step wiring
  and pin-bump/drift stay owned gaps under #783 plus #785; no working site claimed).
