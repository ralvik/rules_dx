...
- Docs pipeline delivered seed-only plus environment/codegen delivered under closed #787 plus onboarding closed #788 (see
   [Documentation](../documentation/README.md#contracts); successors to closed #581 and #506; adapter runs delivered under closed #779, renderer/site execution delivered seed-only under closed #780, rebuild proof delivered seed-only under closed #781, link/reference completeness delivered seed-only under closed #782, guide-step wiring delivered seed-only under closed #783, first-hour timing proof delivered seed-only under #784, per-release pin-bump plus drift process delivered seed-only under #785). Environment/codegen
  ...
  checklist linkage; admitted-pairs evolution onboarding qualified under closed #788
  with checklist plus per-pair fixtures plus qualification coverage for each
  admitted pair; closed #751 plus closed #752 plus closed #753 delivered and out of scope
  for closed #787 plus closed #788; no Supported
...
- Review-thread limit plus accounting frozen at 50 open threads with fixture
  evidence qualified seed-only under closed #592
...
- Starlark testing futures with fixture evidence qualified seed-only under closed #588 plus #790 plus #791 plus #792 plus #793 plus #794 plus #795
  ...
  `starlark_futures_qualification` 40/40;
  ...
  wont-fix on target granularity plus explicit macro instantiation plus single
   ...
   subjects deferred including registered-action (#795) with the
   mnemonic-to-outputs mapping plus resolved-report use case pinned under
   #795 (via `action_subjects.bzl` plus `//libs/starlark/tests:action_unit`,
   stays deferred), second Starlark interpreter plus per-check
