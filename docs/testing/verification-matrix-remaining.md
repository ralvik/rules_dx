...
- Docs pipeline and environment/codegen stay open under #782-#785 and #787 (see
   [Documentation](../documentation/README.md#contracts); successors to closed #581 and #506; adapter runs delivered under #779, renderer/site execution delivered seed-only under #780, rebuild proof delivered seed-only under #781). Environment/codegen
  ...
  planning plus adapter runs plus site-execution plus rebuild records with fixture evidence are qualified seed-only under #779
  plus #780 plus #781
  ...
  outputs only plus byte-identical rebuild proof; link completeness, guide-step wiring, timing proof,
  and pin-bump/drift stay owned gaps under #782-#785; no working site claimed).
