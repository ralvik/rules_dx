...
| --- | --- | --- |
| Linux x86_64 | Linux x86_64 and arm64, each glibc | First Linux cross-build cohort |
| Linux arm64 | Linux arm64 and x86_64, each glibc | Native arm64 glibc qualified (issue #410, CI `ubuntu-24.04-arm`); arm64-to-x86_64 cross stays in the first Linux cross-build cohort |
...
rows qualified under issues #410-#414; Linux
...
plus macOS deployment `14.0` starting
