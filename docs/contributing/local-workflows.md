...
Fresh clone to green build, copy-paste. Linux x86_64 seed host plus Linux arm64 native (issue #410) plus Linux static-musl profiles (issue #411).
...
Build, test, and coverage run through Bazel on Linux x86_64 (plus Linux arm64 native, issue #410, plus static-musl profiles, issue #411) with local-only
execution:
