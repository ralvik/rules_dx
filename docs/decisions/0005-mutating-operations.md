...
and report qualification follow the frozen issue #916 mappings; live
...
issue #916 mappings, not an unrestricted overwrite API.
...
issue #916, and then reports the workspace as busy.
