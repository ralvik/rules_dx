...
PARITY_DEFERRED = {
    ...
    "csharp": ["ADR 0019", "exact upstream package plus shared .NET runtime (CSharpier); Roslyn CA analyzers SDK-coupled -- Scala/.NET cohort owned by issue #417; See: docs/decisions/0019-first-release-additional-foundations.md"],
    ...
    "fsharp": ["ADR 0019", "exact upstream package plus shared .NET runtime (Fantomas); FSharpLint pending -- Scala/.NET cohort owned by issue #417; See: docs/decisions/0019-first-release-additional-foundations.md"],
    ...
    "java": ["ADR 0019", "complete upstream artifact plus shared JDK (google-java-format, Checkstyle, PMD, SpotBugs) -- JVM cohort owned by issue #416; See: docs/decisions/0019-first-release-additional-foundations.md"],
    ...
    "kotlin": ["ADR 0019", "complete upstream artifact plus shared JDK (ktfmt, ktlint); detekt pending -- JVM cohort owned by issue #416; See: docs/decisions/0019-first-release-additional-foundations.md"],
    ...
    "scala": ["ADR 0019", "managed JVM route: compatible JVM artifact (scalafmt); semantic-rule artifacts over shared JDK (Scalafix) -- Scala/.NET cohort owned by issue #417; See: docs/decisions/0019-first-release-additional-foundations.md"],
