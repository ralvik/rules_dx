...
def runner_matrix_cases(name):
    runner_matrix_suite(name, RUST_CASES + PYTHON_CASES + JS_CASES + TS_CASES + JSON_CASES + DATA_CASES + MARKDOWN_CASES + JVM_CASES + SCALA_DOTNET_CASES + NATIVE_CASES + STRUCTURED_CASES)
