...
ADAPTERS_416_420_PARTIAL = "adapters partially under pinned-420 with digests plus adapters staying owned"
...
OWNING_JVM_COHORT = "adapters delivered under pinned (successor to closed #416); digests stay owned"
OWNING_SCALA_DOTNET_COHORT = "adapters delivered under pinned (successor to closed #417); digests stay owned"
OWNING_NATIVE_COHORT = "adapters delivered under pinned (successor to closed #418); digests stay owned"
OWNING_STRUCTURED_COHORT = "digests plus adapters stay owned under pinned"
OWNING_FILE_COHORT = "digests plus adapters stay owned under pinned"
OWNING_DEFAULTS_485 = "versions plus rule-sets qualified under pinned"
OWNING_DEFAULTS_486 = "versions plus rule-sets qualified under pinned"
OWNING_DEFAULTS_487 = "versions plus rule-sets qualified under pinned"
OWNING_FOUNDATIONS_476_484 = "wrappers plus runners plus locks qualified under pinned-#484"
