...
//! below, `.bazelrc` preset onboarding, and any YAML or reporter implementation.
//! Those arrive in later M27 slices. Audit rendering below plans only the
...
//! transport, API limits, and execution stay deferred.
