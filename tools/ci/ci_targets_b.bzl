"""CI hygiene targets shard B (split from `BUILD.bazel`).
...
def add_b():
    ...
    # Release-packaging harness; see docs/deploy/release-runbook.md#packaging.
    sh_binary(
        name = "release_packaging_qualification",
        srcs = ["release_packaging_qualification.sh"],
        data = [
            "//tools/sh:bootstrap",
            "//tools/sh:lib",
        ],
