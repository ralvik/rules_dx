...
bazel run --noshow_progress //tools/ci:laziness_analysis_guard
...
bazel run --noshow_progress //tools/ci:release_matrix_qualification
...
bazel run --noshow_progress //tools/ci:build_profiles_qualification
bazel run --noshow_progress //tools/ci:audit_declared_inputs_qualification
...
bazel run --noshow_progress //tools/ci:file_family_adapters_qualification
...
bazel run --noshow_progress //tools/ci:laziness_host_qualification
