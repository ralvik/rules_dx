"""Docs site execution pins (renderer plus site execution, mdBook).
...
sources; seed-only, no Supported claim.
"""
...
SEED_ONLY = "qualified seed-only under issue #780"
OWNED_GAP = "byte-identical rebuild proof plus link completeness plus guide-step wiring plus timing proof plus pin-bump/drift stay owned gaps under #781-#785"
