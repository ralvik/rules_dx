...
func TestCheckCollisions(t *testing.T) {
	...
	single := []Claimant{{Name: "a", Source: "a.svelte"}, {Name: "b", Source: "b.svelte"}}
	if err := CheckCollisions(single); err != nil {
		t.Errorf("unique collisions = %v", err)
	}
	dupes := []Claimant{{Name: "a_b", Source: "a-b.svelte"}, {Name: "a_b", Source: "a_b.svelte"}}
	...
	if !strings.Contains(message, "a-b.svelte") || !strings.Contains(message, "a_b.svelte") {
