...
// generated rule's ESM regions. Standard-library roots are dropped at
// collection; every other root resolves strictly or fails generation.
type targetImports struct {
	imports []string
}

// NewLanguage returns the private first-party MDX Gazelle extension.
...
// Imports indexes one reusable import identity per MDX source owned
