...
func TestCheckCollisions(t *testing.T) {
	...
	single := []Claimant{{Name: "a", Source: "a.vue"}, {Name: "b", Source: "b.vue"}}
	if err := CheckCollisions(single); err != nil {
		t.Errorf("unique collisions = %v", err)
	}
	dupes := []Claimant{{Name: "a_b", Source: "a-b.vue"}, {Name: "a_b", Source: "a_b.vue"}}
	...
	if !strings.Contains(message, "a-b.vue") || !strings.Contains(message, "a_b.vue") {
