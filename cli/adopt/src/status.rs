...
pub fn default_status_checks(pinned: &str) -> Vec<StatusCheck> {
    ...
    vec![
        ...
        StatusCheck {
            ...
            status: "ok".to_owned(),
            detail: "linux_x86_64 + linux_arm64 glibc plus static musl plus macos_arm64 plus windows_x86_64 qualified"
                .to_owned(),
