...
//! `FinishedCounts`, `write_event`) live in the `lifecycle` module, change
//! and mutation NDJSON events live in the `changes` module. This facade
//! keeps diagnostic/notice events; the public path stays
...
// ---------------------------------------------------------------------------
// Diagnostic / notice events (still on the facade; lifecycle/change
// constructors live in submodules)
// ---------------------------------------------------------------------------
