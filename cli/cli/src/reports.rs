...
//!
//! Domain split (issue #236): LCOV validation/rate lives in
//! [`lcov`](self::lcov), JUnit parsing/rendering in
//! [`junit`](self::junit); SARIF follows in a later slice. The public
//! path stays `crate::reports::{...}` via the re-exports below.
