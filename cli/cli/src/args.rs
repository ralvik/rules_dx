...
//! module, help rendering in the `help` module, and typo suggestions
//! in the `suggest` module. This facade keeps parsing plus the shared
//! types; the public paths stay `crate::args::Command` and
