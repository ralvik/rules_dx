...
DEFECT_CC_OPTOUT_EVIDENCE = "rust/tests/fixtures/cc_optout/ via cc_optout_qualification"
...
DEFECT_TRANSPORT_EVIDENCE = "cc/tests/fixtures/windows_transport/pins.bzl via windows_transport_qualification"
...
DEFECT_ABI_EVIDENCE = "windows_transport_qualification with GNU plus GNULVM rejected"
...
DEFECT_ACQUISITION_EVIDENCE = "cc/tests/fixtures/windows_acquisition/pins.bzl via windows_acquisition_qualification"
...
DEFECT_COVERAGE_EVIDENCE = "cc/tests/fixtures/lcov_accounting/pins.bzl via lcov_accounting_qualification"
...
DEFECT_GENERATION_EVIDENCE = "cc/tests/fixtures/strict_generation/pins.bzl via strict_generation_qualification"
...
DEFECT_IDE_EVIDENCE = "exact-target discovery qualified seed-only plus C++ snapshot qualified seed-only via cpp_snapshot_qualification"
...
DEFECT_FLOORS_EVIDENCE = "glibc 2.28 symbol floor plus deployment 14.0 qualified seed-only"
DEFECT_CROSS = "Cross-product expansion only after the initial cohort passes with bounded upstream configuration"
DEFECT_CROSS_EVIDENCE = "cc/tests/fixtures/cross_routes/pins.bzl via cross_routes_qualification"
